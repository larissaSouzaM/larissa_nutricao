...
var paciente = obtemPacienteDoFormulario(form);
 ...
 /*console.log(form.nome.value);
  ...
  nomeTd.textContent = paciente.nomeAdicionar;
  pesoTd.textContent = paciente.pesoAdicionar;
  alturaTd.textContent = paciente.alturaAdicionar;
  gorduraTd.textContent = paciente.gorduraAdicionar;
